...
const HeroSection = ({ isDarkMode }) => {
  ...
  }, [shouldHideHero, isAnimatingOut, sectionBreaks]);
    ...
    >
      ...
      {stage >= 2 && (
        <div className="hero-content">
          <div className={`hero-base ${isAnimatingOut ? 'expand-fade' : ''}`}>
            {scrollStage === 0 && (
          ...
          {scrollStage === 3 && (
            <div className="buttons-container">
              <PixelButton onClick={downloadResume}>Download Resume</PixelButton>
              <PixelButton onClick={scrollToContact}>Let's Connect</PixelButton>
            </div>
          )}
        </div>
      )}
